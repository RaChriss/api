  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-YVYGXHA6.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-2VNQXSJC.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-JMBNVV3D.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-XJNFZEQB.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-NAQNMNLJ.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-G5XTJTTQ.js.map
